...
Route::resource('venue', App\Http\Controllers\VenueController::class)->only('index', 'show');

Route::resource('speaker', App\Http\Controllers\SpeakerController::class)->only('index', 'show');
